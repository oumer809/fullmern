...
const ProductCard = ({product}) => {
    ...
    return (
        <div className='px-6'>
            ...
            <button className='bg-gray-500 hover:bg-gray-700 text-gray-300 px-4 py-2 rounded-lg text-center w-full transition-all ease-in-out'>Add To Cart</button>
        </div>
        // <div className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full">
        //   <Link to={`/products/${product.id}`}>
        //   <div className="group cursor-pointer flex items-center justify-center px-2 overflow-hidden ">
        //         <img className="group-hover:scale-105 transition w-full object-cover object-top h-70" src={product.image} alt={product.name} />
        //     </div>
        //   </Link>
